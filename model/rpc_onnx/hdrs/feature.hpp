...
namespace LocalInferenceTest {
    class FeatureLoaderExtractor {
        protected:
            std::unique_ptr<OnnxInferencer::DNSOnnxCPUInference> inference;
        ...
        public:
            FeatureLoaderExtractor() : inference(std::make_unique<OnnxInferencer::DNSOnnxCPUInference>()){}
            ...
            std::vector<std::vector<float>>& getFeatures(std::vector<std::string>& domains) {
